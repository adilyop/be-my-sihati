...
import docAdministratifsRoutesRoutes from '../server/routes/docAdministratifsRoutes.js'
...
app.use('/doc-administratif', resClock.protect(), docAdministratifsRoutesRoutes);
